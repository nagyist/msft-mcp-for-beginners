...
![Configuração guiada do MCP Server no Visual Studio Code](../../../../translated_images/pt-PT/chat-mode-agent.729a22473f822216.webp)
![Seleção de ferramentas por sessão de agente](../../../../translated_images/pt-PT/agent-mode-select-tools.522c7ba5df0848f8.webp)
![Depuração fácil de erros durante o desenvolvimento de MCP](../../../../translated_images/pt-PT/mcp-list-servers.fce89eefe3f30032.webp)
...
1. Para executar uma ferramenta, digite um prompt que corresponda à descrição de uma das suas ferramentas, por exemplo, um prompt como "adicionar 22 a 1":
  ...
  ![Executar uma ferramenta no GitHub Copilot](../../../../translated_images/pt-PT/vscode-agent.d5a0e0b897331060.webp)
