...
1. Quando um navegador abrir o dashboard do .NET Aspire, note a URL `http`. Deve ser algo como `http://localhost:5058/`.
   ...
   ![.NET Aspire Dashboard](../../../../../translated_images/pt-PT/dotnet-aspire-dashboard.0a7095710e9301e9.webp)
...
![Azd deployment success](../../../../../translated_images/pt-PT/azd-deployment-success.bd42940493f1b834.webp)
