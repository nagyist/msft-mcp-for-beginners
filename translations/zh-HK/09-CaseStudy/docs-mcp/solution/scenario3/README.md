...
1. **新增 MCP 設定：**  
   ...
   ![Step 1: Add mcp.json to .vscode folder](../../../../../../translated_images/zh-HK/step1-mcp-json.c06a007fccc3edfa.webp)
...
2. **開啟 GitHub Copilot Chat 面板：**  
   ...
   ![Step 2: Open Copilot Chat panel](../../../../../../translated_images/zh-HK/step2-copilot-panel.f1cc86e9b9b8cd1a.webp)

3. **啟用 agent 模式並確認工具：**  
   在 Copilot Chat 面板中，啟用 agent 模式。

   ![Step 3: Enable agent mode and verify tools](../../../../../../translated_images/zh-HK/step3-agent-mode.cdc32520fd7dd1d1.webp)

   啟用後，確認 MCP server 已列為可用工具之一。這確保 Copilot agent 能存取文件伺服器，取得相關資訊。

   ![Step 3: Verify MCP server tool](../../../../../../translated_images/zh-HK/step3-verify-mcp-tool.76096a6329cbfecd.webp)
...
4. **開始新對話並向 agent 提問：**  
   ...
   ![Step 4: Prompt the agent in chat](../../../../../../translated_images/zh-HK/step4-prompt-chat.12187bb001605efc.webp)
...
5. **即時查詢：**
   ...
   *「我想了解如何部署多代理解決方案，這些 AI 代理是在 Azure AI Foundry 上開發的。我發現沒有像 Copilot Studio 頻道那樣的直接部署方式。那麼，企業用戶要如何部署，才能互動並完成工作？  
   ...
   ![Step 5: Live queries](../../../../../../translated_images/zh-HK/step5-live-queries.49db3e4a50bea273.webp)
