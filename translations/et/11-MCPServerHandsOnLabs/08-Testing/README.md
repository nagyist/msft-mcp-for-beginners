...
See labor pakub põhjalikku juhendit MCP serverite testimiseks ja silumiseks tootmiskeskkondades. Õpid rakendama tugevaid testimisstrateegiaid, lahendama keerulisi probleeme ja tagama, et MCP server toimib usaldusväärselt erinevates tingimustes.

## Ülevaade

MCP serverite testimine nõuab mitmekihilist lähenemist, mis hõlmab üksusteste, integratsiooniteste, jõudluse valideerimist ja reaalse maailma stsenaariumide testimist. See labor katab kogu testimise elutsükli alates arendamisest kuni tootmise jälgimiseni.

Meie testimisstrateegia keskendub usaldusväärsusele, turvalisusele ja jõudlusele, tagades, et MCP server suudab toime tulla tootmiskoormustega, säilitades samal ajal andmete terviklikkuse ja kasutajakogemuse kvaliteedi.

## Õpieesmärgid

Labori lõpuks oskad:

- **Rakendada** põhjalikke üksus- ja integratsioonitestide komplekte
- **Kavandada** tõhusaid testimisstrateegiaid MCP tööriistade ja andmebaasi operatsioonide jaoks
- **Siluda** keerulisi probleeme, kasutades täiustatud silumistehnikaid
- **Valideerida** jõudlust koormuse all realistlike testimistsenaariumidega
- **Jälgida** tootmissüsteeme tõhusate hoiatuste ja jälgitavuse abil
- **Automatiseerida** testimisvooge pideva integreerimise jaoks

## 🧪 Testimise arhitektuur

### Testimisstrateegia ülevaade
...
### Tööriistade testimise raamistik
...
### Töövoo testimine algusest lõpuni
...
Pärast labori lõpetamist peaksid omama:

✅ **Põhjalikku testimisraamistikku**: Üksus-, integratsiooni- ja jõudlustestid kõigi komponentide jaoks  
✅ **Täiustatud silumistööriistu**: Kogenud silumisvahendid koos täitmise jälgimisega  
✅ **Jõudluse valideerimist**: Koormustestimise ja skaleeritavuse analüüsi võimalused  
✅ **Turvalisuse testimist**: SQL-injektsioonide ennetamine ja RLS-i valideerimine  
✅ **Jälgimise integreerimist**: Jõudlusmõõdikud ja kitsaskohtade analüüs  
✅ **CI/CD valmidust**: Automaatne testimisvoog pideva integreerimise jaoks  

## 🚀 Mis edasi?

Jätka **[Labor 09: VS Code integratsioon](../09-VS-Code/README.md)**, et:

- Konfigureerida VS Code MCP serveri arendamiseks
- Seadistada silumiskeskkonnad VS Code'is
- Integreerida MCP server VS Code Chatiga
- Testida täielikku VS Code töövoogu

## 📚 Täiendavad ressursid

### Testimisraamistikud
- [pytest dokumentatsioon](https://docs.pytest.org/) - Python'i testimisraamistik
- [AsyncPG testimine](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL testimine
- [FastAPI testimine](https://fastapi.tiangolo.com/tutorial/testing/) - API testimise mustrid

### Jõudluse testimine
- [Koormustestimise parimad praktikad](https://docs.python.org/3/library/asyncio.html) - Async jõudluse testimine
- [Andmebaasi jõudluse testimine](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL optimeerimine
- [Mälu profiilimine](https://docs.python.org/3/library/tracemalloc.html) - Python'i mälu analüüs

### Silumistööriistad
- [Python'i silumine](https://docs.python.org/3/library/pdb.html) - Python'i silur
- [Async silumine](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio silumine
- [SQL silumine](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL logimine

---

**Eelmine**: [Labor 07: Semantilise otsingu integratsioon](../07-Semantic-Search/README.md)  
**Järgmine**: [Labor 09: VS Code integratsioon](../09-VS-Code/README.md)
