...
See labor keskendub keerukate MCP tööriistade loomisele, mis annavad AI assistentidele võimsad võimalused andmebaasi päringute tegemiseks, skeemi analüüsimiseks ja analüütikafunktsioonide kasutamiseks. Õpid looma tööriistu, mis on nii võimsad kui ka turvalised, pakkudes põhjalikku veakäsitlust ja jõudluse optimeerimist.

## Ülevaade

MCP tööriistad on liides AI assistentide ja teie andmesüsteemide vahel. Hästi kujundatud tööriistad pakuvad struktureeritud ja valideeritud juurdepääsu keerukatele operatsioonidele, säilitades samal ajal turvalisuse ja jõudluse. See labor hõlmab tööriistade arendamise täielikku elutsüklit alates disainist kuni juurutamiseni.

Meie jaemüügi MCP server rakendab terviklikku tööriistade komplekti, mis võimaldab müügiandmete, tootekataloogide ja ärianalüütika loomulikku keelepäringut, säilitades samal ajal rangelt turvalisuse ja optimaalse jõudluse.

## Õpieesmärgid

Labori lõpuks oskad:

- **Disainida** arenenud MCP tööriistu keeruka parameetrite valideerimisega
- **Rakendada** turvalisi andmebaasi päringutööriistu SQL-injektsioonide kaitsega
- **Luua** skeemi analüüsimise võimalusi dünaamiliste päringute jaoks
- **Ehita** kohandatud analüütikatööriistu äriluure jaoks
- **Rakendada** põhjalikku veakäsitlust ja sujuvat degradeerumist
- **Optimeerida** tööriistade jõudlust tootmiskoormuste jaoks

## 🛠️ Tööriistade põhistruktuur

### Tööriistade disainipõhimõtted
...
### Päringute valideerimine ja turvalisus
...
## 🗃️ Andmebaasi päringutööriistad

### Müügi analüüsi tööriist
...
## 📊 Analüütika ja utiliiditööriistad
...
Pärast labori lõpetamist peaksid olema saavutanud:

✅ **Arenenud tööriistade arhitektuur**: Rakendanud keerukaid MCP tööriistu põhjaliku veakäsitlusega  
✅ **Päringute valideerimine**: Loonud turvalise SQL valideerimise, et vältida injektsioonirünnakuid  
✅ **Andmebaasi tööriistad**: Loonud võimsad müügi analüüsi ja skeemi analüüsimise võimalused  
✅ **Äriluure**: Arendanud analüütikatööriistu põhjalike äriliste teadmiste jaoks  
✅ **Jõudluse optimeerimine**: Rakendanud vahemällu salvestamist, ühenduste haldamist ja päringute optimeerimist  
✅ **Turvalisuse integreerimine**: Rakendanud rollipõhist juurdepääsukontrolli ja auditeerimislogimist  

## 🚀 Mis edasi

Jätka **[Labor 07: Semantilise otsingu integreerimine](../07-Semantic-Search/README.md)**, et:

- Integreerida MCP tööriistadega vektoriotsingu võimalused
- Luua semantilise tooteotsingu funktsionaalsus
- Rakendada AI-põhist päringute mõistmist
- Luua hübriidotsing, mis kombineerib traditsioonilisi ja vektoripäringuid

## 📚 Täiendavad ressursid

### MCP tööriistade arendamine
- [Model Context Protocol Dokumentatsioon](https://modelcontextprotocol.io/docs) - MCP ametlik spetsifikatsioon
- [FastMCP raamistik](https://github.com/jlowin/fastmcp) - MCP Pythonis rakendamine
- [MCP tööriistade mustrid](https://github.com/modelcontextprotocol/servers) - Näidistööriistade rakendused

### Andmebaasi turvalisus
- [SQL-injektsiooni ennetamine](https://owasp.org/www-community/attacks/SQL_Injection) - OWASP turvalisuse juhend
- [PostgreSQL turvalisus](https://www.postgresql.org/docs/current/security.html) - Andmebaasi turvalisuse parimad tavad
- [Päringute valideerimise tehnikad](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Turvalised päringumustrid

### Jõudluse optimeerimine
- [Andmebaasi päringute optimeerimine](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL jõudluse juhend
- [Ühenduste haldamise parimad tavad](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Ühenduste haldamine
- [Asünkroonse Python mustrid](https://docs.python.org/3/library/asyncio.html) - Asünkroonse programmeerimise juhend

---

**Eelmine**: [Labor 05: MCP serveri rakendamine](../05-MCP-Server/README.md)  
**Järgmine**: [Labor 07: Semantilise otsingu integreerimine](../07-Semantic-Search/README.md)
