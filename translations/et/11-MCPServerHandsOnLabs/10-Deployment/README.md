...
See labor pakub põhjalikku juhendit MCP jaemüügiserveri juurutamiseks tootmiskeskkondades, kasutades kaasaegseid konteineriseerimise ja pilvepõhiseid lähenemisviise. Õpid juurutama skaleeritavaid, turvalisi ja jälgitavaid MCP servereid, mis suudavad toime tulla ettevõtte töökoormustega.

## Ülevaade

MCP serverite tootmiskeskkonda juurutamine nõuab hoolikat kaalutlemist konteineriseerimise, orkestreerimise, turvalisuse, skaleeritavuse ja jälgimise osas. See labor hõlmab juurutamist Azure Container Apps-i koos PostgreSQL Flexible Serveriga, CI/CD torujuhtmete rakendamist ja automaatse skaleerimise seadistamist muutuvate töökoormuste jaoks.

Juurutamisstrateegiad ulatuvad lihtsatest ühe konteineriga arendusjuurutustest kuni keerukate mitme piirkonna, automaatselt skaleeruvate tootmiskeskkondadeni, mis sisaldavad põhjalikke jälgimis- ja turvafunktsioone.

## Õpieesmärgid

Selle labori lõpuks oskad:

- **Konteineriseerida** MCP servereid, kasutades Dockeri mitme etapi ehitust
- **Juurutada** Azure Container Apps-i turvalise võrgustikuga
- **Seadistada** tootmiskõlbulikku PostgreSQL-i kõrge saadavusega
- **Rakendada** CI/CD torujuhtmeid automaatseks juurutamiseks
- **Skaleerida** rakendusi automaatselt vastavalt nõudlusele
- **Jälgida** tootmiskeskkonna juurutusi põhjaliku jälgitavusega

## 🐳 Dockeri konteineriseerimine

### Mitme etapi Dockerfile
...
## ☁️ Azure Container Apps-i juurutamine
...
### Automaatse skaleerimise seadistamine
...
Pärast selle labori lõpetamist peaksid olema saavutanud:

✅ **Konteineristrateegia**: Tootmiskõlbulikud Dockeri konteinerid turvalisuse tugevdamisega  
✅ **Pilvejuurutamine**: Azure Container Apps automaatse skaleerimise ja jälgimisega  
✅ **Andmebaasi juurutamine**: PostgreSQL Flexible Server kõrge saadavusega  
✅ **CI/CD torujuhtmed**: Automaatse testimise, ehitamise ja juurutamise töövood  
✅ **Jõudluse jälgimine**: Põhjalik metrikate kogumine ja hoiatused  
✅ **Turvaseadistused**: Tootmiskõlbulikud turvapoliitikad ja võrgustiku isoleerimine  

## 🚀 Mis edasi?

Jätka **[Labor 11: Jälgimine ja nähtavus](../11-Monitoring/README.md)**, et:

- Seadistada põhjalik jälgimine Application Insights-iga
- Konfigureerida struktureeritud logimine ja hajutatud jälgimine
- Rakendada hoiatus- ja automaatseid reageerimissüsteeme
- Jälgida ärimetrikaid ja jõudluse KPI-sid

## 📚 Lisamaterjalid

### Konteineritehnoloogiad
- [Dockeri parimad praktikad](https://docs.docker.com/develop/dev-best-practices/) - Ametlikud Dockeri parimad praktikad
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps dokumentatsioon
- [Kubernetese dokumentatsioon](https://kubernetes.io/docs/) - Kubernetese ametlik dokumentatsioon

### CI/CD ja DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions dokumentatsioon
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps teenused
- [Infrastruktuur kui kood](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep dokumentatsioon

### Turvalisus ja jälgimine
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Azure turvasoovitused
- [Konteinerite turvalisus](https://kubernetes.io/docs/concepts/security/) - Kubernetese turvalisuse kontseptsioonid
...
**Eelmine**: [Labor 09: VS Code integratsioon](../09-VS-Code/README.md)  
**Järgmine**: [Labor 11: Jälgimine ja nähtavus](../11-Monitoring/README.md)
