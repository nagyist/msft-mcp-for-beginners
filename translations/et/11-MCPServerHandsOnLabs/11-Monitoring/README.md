...
See labor pakub põhjalikku juhendit MCP serveri jälgimise, jälgitavuse ja häirete seadistamiseks tootmiskeskkonnas. Õpid seadistama Application Insightsi, looma tähendusrikkaid juhtpaneele, rakendama tõhusat häiresüsteemi ja koostama tõrkeotsingu töövooge operatiivse tipptaseme saavutamiseks.

## Ülevaade

Tõhus jälgimine ja jälgitavus on hädavajalikud usaldusväärsete MCP serverite hooldamiseks tootmiskeskkonnas. See labor hõlmab jälgitavuse kolme tugisammast—mõõdikud, logid ja jäljed—ning näitab, kuidas rakendada terviklikku jälgimist, mis võimaldab probleemide ennetavat tuvastamist ja kiiret lahendamist.

Õpid muutma toortelemeetriaandmed praktilisteks teadmisteks, mis aitavad sul mõista süsteemi käitumist, optimeerida jõudlust ja tagada kõrge saadavus.

## Õpieesmärgid

Labori lõpuks oskad:

- **Rakendada** terviklikku Application Insightsi integreerimist MCP serveritele
- **Kavandada** struktureeritud logimismustreid tõhusaks tõrkeotsinguks
- **Luua** süsteeme jõudlusmõõdikute kogumiseks ja analüüsimiseks
- **Seadistada** nutikaid häiresüsteeme koos praktiliste teavitustega
- **Ehita** operatiivseid juhtpaneele reaalajas jälgimiseks
- **Kehtestada** tõhusad tõrkeotsingu töövood ja juhendid

## 📊 Application Insightsi integreerimine

### Application Insightsi seadistamine
...
### Täiustatud logimine struktureeritud andmetega
...
## 📈 Juhtpaneelide loomine

### Azure Monitori töövihikud
...
### Kohandatud juhtpaneelide rakendamine
...
✅ **Application Insightsi integreerimine**: Täielik telemeetria ja jälgimise seadistus  
✅ **Struktureeritud logimine**: Tootmiskõlblik logimine koos korrelatsiooni ja kontekstiga  
✅ **Kohandatud mõõdikud**: Äri- ja tehniliste mõõdikute kogumine ja analüüs  
✅ **Nutikas häiresüsteem**: Ennetav häiresüsteem mitme teavitamiskanali kaudu  
✅ **Operatiivsed juhtpaneelid**: Reaalajas jälgimine ja ärilised teadmised  
✅ **Tõrkeotsingu töövood**: Automatiseeritud diagnostika ja operatiivsed juhendid  

## 🚀 Mis edasi?

Jätka **[Labor 12: Parimad tavad ja optimeerimine](../12-Best-Practices/README.md)**, et:

- Rakendada jõudluse optimeerimise tehnikaid
- Teostada põhjalikku turvameetmete tugevdamist
- Õppida tootmiskeskkonna juurutamise parimaid tavasid
- Kehtestada kulude optimeerimise strateegiaid

## 📚 Täiendavad ressursid

### Azure Monitor
- [Application Insightsi dokumentatsioon](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Terviklik jälgimise juhend
- [KQL päringute viide](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Päringukeel Application Insightsi jaoks
- [Azure Monitori töövihikud](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Kohandatud juhtpaneelide loomine

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Instrumenteerimise juhend
- [Jaotatud jälgimine](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Jälgimise kontseptsioonid
- [Mõõdikute kogumine](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Mõõdikute parimad tavad

### Operatiivne tipptase
- [SRE käsiraamat](https://sre.google/sre-book/table-of-contents/) - Saidi usaldusväärsuse inseneri põhimõtted
- [Jälgimise parimad tavad](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Tööstuse parimad tavad
- [Intsidendihaldus](https://response.pagerduty.com/) - Intsidendihalduse juhend

---

**Eelmine**: [Labor 10: Juurutamisstrateegiad](../10-Deployment/README.md)  
**Järgmine**: [Labor 12: Parimad tavad ja optimeerimine](../12-Best-Practices/README.md)
