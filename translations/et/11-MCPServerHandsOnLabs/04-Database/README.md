# Andmebaasi kujundus ja skeem

## 🎯 Mida see labor hõlmab

See labor keskendub PostgreSQL andmebaasi kujundusele Zava Retail süsteemi jaoks. Õpid rakendama terviklikku jaemüügi skeemi, mis sisaldab vektoriotsingu võimalusi, mitme rentniku andmemudelit ja ridade tasemel turvalisust (RLS) andmete eraldamiseks.

## Ülevaade

Andmebaas on meie MCP serveri alus, salvestades jaemüügiandmeid mitme poe kohta, säilitades samal ajal range andmete eraldamise. Kasutame PostgreSQL-i koos pgvector laiendusega, et võimaldada semantilist otsingut, mis võimaldab klientidel leida tooteid loomuliku keele päringute abil.

Meie skeem järgib kaasaegseid mitme rentniku mustreid, kus ridade tasemel turvalisus tagab, et kasutajad pääsevad ligi ainult oma volitatud poodide andmetele. See lähenemine pakub ettevõtte tasemel turvalisust, säilitades samal ajal optimaalse jõudluse.

## Õpieesmärgid

Labori lõpuks oskad:

- **Kujundada** skaleeritavaid mitme rentniku jaemüügi andmebaasi skeeme
- **Rakendada** PostgreSQL-i koos pgvectoriga vektoriotsingu jaoks
- **Konfigureerida** ridade tasemel turvalisust andmete eraldamiseks
- **Luua** realistlikke näidisandmeid testimiseks
- **Optimeerida** andmebaasi jõudlust jaemüügi töökoormuste jaoks
- **Rakendada** varundamise ja taastamise strateegiaid

## 🗃️ Andmebaasi arhitektuur

### PostgreSQL koos pgvectoriga

Meie andmebaas kasutab PostgreSQL-i ettevõtte funktsioone koos pgvector laiendusega AI-põhise otsingu jaoks:
...
### Mitme rentniku arhitektuur

Andmebaas kasutab **jagatud andmebaasi, jagatud skeemi** mitme rentniku mudelit koos ridade tasemel turvalisusega:
...
### Toodete tabel koos kategooriatega
...
## 🔍 Vektoriotsingu rakendamine

### Toodete sisendite tabel
...
## 🔐 Ridade tasemel turvalisuse seadistamine

### Andmebaasi rollid ja õigused
...
### Päringute optimeerimise vaated
...
Pärast labori lõpetamist peaksid olema:

✅ **Mitme rentniku andmebaasi kujundus**: Rakendanud ridade tasemel turvalisuse andmete eraldamiseks  
✅ **Vektoriotsingu võimalused**: Konfigureerinud pgvectori semantilise tooteotsingu jaoks  
✅ **Terviklik skeem**: Loonud tootmisvalmis jaemüügi andmebaasi skeemi  
✅ **Näidisandmete genereerimine**: Loonud realistlikud testandmed arenduseks ja testimiseks  
✅ **Jõudluse optimeerimine**: Konfigureerinud indeksid ja päringute optimeerimise  
✅ **Varundamine ja taastamine**: Kehtestanud usaldusväärsed andmekaitse strateegiad  

## 🚀 Mis edasi

Jätka **[Labor 05: MCP serveri rakendamine](../05-MCP-Server/README.md)**, et:

- Luua FastMCP server, mis ühendub selle andmebaasiga
- Rakendada andmebaasi päringutööriistu MCP protokolli jaoks
- Lisada semantilise otsingu võimalused sisendite abil
- Konfigureerida ühenduste haldamist ja vigade käsitlemist

## 📚 Täiendavad ressursid

### PostgreSQL & pgvector
- [PostgreSQL dokumentatsioon](https://www.postgresql.org/docs/) - Täielik PostgreSQL viide
- [pgvector laiendus](https://github.com/pgvector/pgvector) - Vektori sarnasuse otsing PostgreSQL jaoks
- [PostgreSQL jõudluse häälestamine](https://wiki.postgresql.org/wiki/Performance_Optimization) - Optimeerimise parimad tavad

### Mitme rentniku arhitektuur
- [Ridade tasemel turvalisus](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS dokumentatsioon
- [Mitme rentniku andmearhitektuur](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure arhitektuuri mustrid
- [Andmebaasi turvalisuse parimad tavad](https://www.postgresql.org/docs/current/security.html) - PostgreSQL turvalisuse juhend

### Vektorandmebaasid
- [Vektoriotsingu alused](https://www.pinecone.io/learn/vector-database/) - Vektorandmebaaside mõistmine
- [Sisendmudelid](https://platform.openai.com/docs/guides/embeddings) - OpenAI sisendite dokumentatsioon
- [HNSW algoritm](https://arxiv.org/abs/1603.09320) - Hierarhilised navigeeritavad väikesed maailmagraafid

---

**Eelmine**: [Labor 03: Keskkonna seadistamine](../03-Setup/README.md)  
**Järgmine**: [Labor 05: MCP serveri rakendamine](../05-MCP-Server/README.md)
