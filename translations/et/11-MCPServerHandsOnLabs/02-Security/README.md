# Turvalisus ja mitme rentniku tugi

## 🎯 Mida see labor hõlmab

See labor pakub põhjalikku juhendit ettevõtte tasemel turvalisuse ja mitme rentniku toe rakendamiseks MCP serveritele. Õpid kujundama turvalisi ja nõuetele vastavaid süsteeme, mis kaitsevad tundlikke jaemüügiandmeid ning võimaldavad paindlikke juurdepääsumustreid mitme rentniku vahel.

## Ülevaade

Turvalisus on ülioluline jaemüügirakendustes, mis töötlevad kliendiandmeid, makseinfot ja äriluureandmeid. See labor hõlmab täielikku turvaarhitektuuri alates autentimisest ja autoriseerimisest kuni andmete eraldamise ja vastavuse jälgimiseni.

Rakendame süvaturbe strateegiat, mis ühendab Azure identiteediteenused, PostgreSQL-i rea tasemel turvalisuse (Row Level Security), rakenduse tasemel kontrollid ja põhjaliku logimise, et luua tugev ja nõuetele vastav platvorm.

## Õpieesmärgid

Labori lõpuks suudad:

- **Rakendada** ettevõtte tasemel rea tasemel turvalisust mitme rentniku andmete eraldamiseks
- **Kujundada** turvalisi autentimise ja autoriseerimise mustreid Azure'i abil
- **Konfigureerida** põhjalikku logimist vastavusnõuete täitmiseks
- **Rakendada** süvaturbe strateegiaid kõigil rakenduse kihtidel
- **Kinnitada** turvalisuse rakendusi süsteemse testimise kaudu
- **Jälgida** turvaintsidente ja reageerida võimalikele ohtudele

## 🔐 Mitme rentniku turvaarhitektuur
...
### Mitme rentniku mudelid

Meie rakendus kasutab **Jagatud andmebaasi, jagatud skeemi** mudelit koos rea tasemel turvalisusega:

**Eelised:**
- Kulutõhus ressursside kasutamine
- Lihtsustatud hooldus ja uuendused
- Tugev andmete eraldamine RLS-i kaudu
- Vastavusnõuetele sobivad logid

**Kompromissid:**
- Vajab hoolikat RLS-i poliitikate kujundamist
- Skeemimuudatused mõjutavad kõiki rentnikke
- Vajalikud tugevad varundamise/taastamise protseduurid

## 🛡️ Rea tasemel turvalisuse rakendamine
...
### RLS-i testimine ja valideerimine
...
## 🧪 Turvalisuse testimine ja valideerimine

### Automaatne turvatestimine
...
### Läbimurdetestimise kontrollnimekiri
...
Pärast labori läbimist peaksid olema:

✅ **Mitme rentniku turvalisus**: Rakendanud rea tasemel turvalisuse täielikuks andmete eraldamiseks  
✅ **Azure autentimine**: Integreerinud Azure Entra ID koos JWT valideerimisega  
✅ **Rollipõhine autoriseerimine**: Konfigureerinud hierarhilise rolli- ja õiguste süsteemi  
✅ **Põhjalik logimine**: Loonud turvaintsidentide jälgimise ja monitooringu  
✅ **Turvatestimine**: Rakendanud automaatseid turvalisuse valideerimise teste  
✅ **Ohu jälgimine**: Loonud reaalajas turvaintsidentide tuvastamise ja hoiatamise  

## 🚀 Mis edasi

Jätka **[Labor 03: Keskkonna seadistamine](../03-Setup/README.md)**, et:

- Konfigureerida arenduskeskkonnad turvalisuse parimate tavadega
- Seadistada Azure teenused autentimiseks ja monitooringuks
- Rakendada turvalisi andmebaasiühendusi ja salajaste andmete haldust
- Kinnitada turvaseadistused arenduskeskkondades

## 📚 Täiendavad ressursid

### Azure turvalisus
- [Azure Entra ID dokumentatsioon](https://docs.microsoft.com/azure/active-directory/) - Täielik identiteediplatvormi juhend
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Salajaste andmete haldusteenus
- [Azure turvalisuse parimad tavad](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Turvalisuse juhised

### Andmebaasi turvalisus
- [PostgreSQL rea tasemel turvalisus](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Ametlik RLS-i dokumentatsioon
- [Andmebaasi turvalisuse kontrollnimekiri](https://www.postgresql.org/docs/current/security.html) - PostgreSQL turvalisuse juhend
- [Mitme rentniku andmebaasi mustrid](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Arhitektuurimustrid

### Turvatestimine
- [OWASP testimisjuhend](https://owasp.org/www-project-web-security-testing-guide/) - Põhjalik turvatestimine
- [JWT turvalisuse parimad tavad](https://tools.ietf.org/html/rfc8725) - JWT turvalisuse kaalutlused
- [API turvatestimine](https://owasp.org/www-project-api-security/) - API-spetsiifiline turvatestimine

---

**Eelmine**: [Labor 01: Põhiarhitektuuri kontseptsioonid](../01-Architecture/README.md)  
**Järgmine**: [Labor 03: Keskkonna seadistamine](../03-Setup/README.md)
