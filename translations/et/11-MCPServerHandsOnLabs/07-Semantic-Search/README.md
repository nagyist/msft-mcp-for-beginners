...
See labor pakub põhjalikku juhendit semantilise otsingu rakendamiseks, kasutades Azure OpenAI vektorite loomist ja PostgreSQL pgvector laiendust. Õpid looma tehisintellekti abil töötavat tootepõhist otsingut, mis mõistab loomuliku keele päringuid ja pakub asjakohaseid tulemusi semantilise sarnasuse alusel.

## Ülevaade

Traditsiooniline märksõnapõhine otsing ei suuda sageli tabada kasutaja kavatsust ja semantilist tähendust. Semantiline otsing, mis kasutab vektorite loomist, võimaldab loomuliku keele päringutel, nagu "mugavad jooksujalatsid vihmaseks ilmaks", leida asjakohaseid tooteid isegi siis, kui need täpsed sõnad tootekirjeldustes ei esine.

Meie lahendus ühendab Azure OpenAI võimsad vektorite loomise mudelid PostgreSQL pgvector laiendusega, et luua suure jõudlusega ja skaleeritav semantiline otsingusüsteem, mis täiustab jaemüügikogemust intelligentse tootepõhise avastamisega.

## Õpieesmärgid

Labori lõpuks oskad:

- **Integreerida** Azure OpenAI vektorite loomise mudelid tekstide vektoriseerimiseks
- **Rakendada** pgvectori tõhusate sarnasuspäringute jaoks
- **Luua** semantilisi otsingutööriistu loomuliku keele päringute jaoks
- **Kombineerida** traditsioonilist ja vektoripõhist otsingut hübriidotsinguks
- **Optimeerida** vektoripäringuid tootmiskeskkonna jõudluse jaoks
- **Kavandada** soovitussüsteeme, mis põhinevad vektorite sarnasusel

## 🧠 Semantilise otsingu arhitektuur

### Vektoripõhise otsingu torustik
...
## 🔍 Tootepõhiste vektorite loomine

### Automatiseeritud vektorite loomise torustik
...
## 🔎 Semantilised otsingutööriistad

### Semantiline tootepõhine otsingutööriist
...
### Vektoripäringute optimeerimine
...
Pärast labori läbimist peaksid olema saavutanud:

✅ **Azure OpenAI integratsioon**: Täielik vektorite loomine koos vahemälu ja optimeerimisega  
✅ **Vektoripõhise otsingu rakendamine**: Tootmiskeskkonna semantiline otsing pgvectoriga  
✅ **Hübriidotsingu võimalused**: Märksõna- ja semantilise otsingu kombinatsioon parimate tulemuste saavutamiseks  
✅ **Soovitussüsteemid**: Tehisintellekti abil töötavad tootepõhised soovitused sarnasuse alusel  
✅ **Jõudluse optimeerimine**: Vektorite indeksi optimeerimine ja intelligentne vahemälu  
✅ **Skaleeritav arhitektuur**: Ettevõtte tasemel semantilise otsingu infrastruktuur  

## 🚀 Mis edasi?

Jätka **[Labor 08: Testimine ja silumine](../08-Testing/README.md)**, et:

- Rakendada põhjalikke testimisstrateegiaid semantilise otsingu jaoks
- Siluda vektoripõhise otsingu jõudlusprobleeme
- Kontrollida vektorite kvaliteeti ja asjakohasust
- Testida soovitussüsteemi täpsust

## 📚 Lisamaterjalid

### Azure OpenAI
- [Azure OpenAI teenuse dokumentatsioon](https://docs.microsoft.com/azure/cognitive-services/openai/) - Täielik teenuse juhend
- [Vektorite API viide](https://platform.openai.com/docs/api-reference/embeddings) - API dokumentatsioon
- [Parimad praktikad vektorite loomiseks](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Rakendamise juhised

### Vektoripõhised andmebaasid
- [pgvector dokumentatsioon](https://github.com/pgvector/pgvector) - PostgreSQL vektorilaiendus
- [Vektoripõhise otsingu optimeerimine](https://www.pinecone.io/learn/vector-search-optimization/) - Jõudluse häälestamine
- [HNSW algoritm](https://arxiv.org/abs/1603.09320) - Hierarhilised navigeeritavad väikesed maailmagraafid

### Semantiline otsing
- [Informatsiooniotsingu alused](https://nlp.stanford.edu/IR-book/) - Stanfordi IR õpik
- [Vektoripõhise otsingu parimad praktikad](https://weaviate.io/blog/vector-search-best-practices) - Rakendamise mustrid
- [Hübriidotsingu strateegiad](https://blog.vespa.ai/hybrid-search/) - Erinevate otsingumeetodite kombineerimine

---

**Eelmine**: [Labor 06: Tööriistade arendamine](../06-Tools/README.md)  
**Järgmine**: [Labor 08: Testimine ja silumine](../08-Testing/README.md)
