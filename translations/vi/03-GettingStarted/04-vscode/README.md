...
![Cấu hình MCP Server có hướng dẫn trong Visual Studio Code](../../../../translated_images/vi/chat-mode-agent.729a22473f822216.webp)
![Chọn công cụ cho mỗi phiên agent](../../../../translated_images/vi/agent-mode-select-tools.522c7ba5df0848f8.webp)
![Dễ dàng gỡ lỗi trong quá trình phát triển MCP](../../../../translated_images/vi/mcp-list-servers.fce89eefe3f30032.webp)
...
1. Để chạy một công cụ, nhập một lệnh mà bạn biết sẽ khớp với mô tả của một trong các công cụ của bạn, ví dụ như lệnh "add 22 to 1":
  ...
  ![Chạy một công cụ từ GitHub Copilot](../../../../translated_images/vi/vscode-agent.d5a0e0b897331060.webp)
