...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-11T14:46:16+00:00",
...
ഈ ലാബ് ശക്തമായ ഡാറ്റാബേസ് ക്വറി കഴിവുകൾ, സ്കീമ ഇൻട്രോസ്പെക്ഷൻ, അനലിറ്റിക്സ് ഫംഗ്ഷനുകൾ എന്നിവയുള്ള എഐ അസിസ്റ്റന്റുകൾക്ക് ശക്തമായ MCP ടൂളുകൾ സൃഷ്ടിക്കുന്നതിൽ ആഴത്തിൽ പ്രവേശിക്കുന്നു. സമഗ്രമായ പിശക് കൈകാര്യം ചെയ്യലും പ്രകടന മെച്ചപ്പെടുത്തലും ഉള്ള ശക്തവും സുരക്ഷിതവുമായ ടൂളുകൾ നിർമ്മിക്കാൻ നിങ്ങൾ പഠിക്കും.

## അവലോകനം

MCP ടൂളുകൾ എഐ അസിസ്റ്റന്റുകളും നിങ്ങളുടെ ഡാറ്റാ സിസ്റ്റങ്ങളും തമ്മിലുള്ള ഇന്റർഫേസാണ്. നന്നായി രൂപകൽപ്പന ചെയ്ത ടൂളുകൾ സങ്കീർണ്ണമായ പ്രവർത്തനങ്ങൾക്ക് ഘടനാപരവും സാധൂകരിച്ചും ആക്സസ് നൽകുന്നു, സുരക്ഷയും പ്രകടനവും നിലനിർത്തുന്നു. ഈ ലാബ് രൂപകൽപ്പന മുതൽ വിനിയോഗം വരെ ടൂൾ വികസനത്തിന്റെ പൂർണ്ണ ജീവിതചക്രം ഉൾക്കൊള്ളുന്നു.

നമ്മുടെ റീട്ടെയിൽ MCP സെർവർ വിൽപ്പന ഡാറ്റ, ഉൽപ്പന്ന കാറ്റലോഗുകൾ, ബിസിനസ് അനലിറ്റിക്സ് എന്നിവയുടെ സ്വാഭാവിക ഭാഷാ ക്വറിയിംഗ് സാധ്യമാക്കുന്ന സമഗ്രമായ ടൂൾ സ്യൂട്ട് നടപ്പിലാക്കുന്നു, കർശനമായ സുരക്ഷാ പരിധികളും മികച്ച പ്രകടനവും നിലനിർത്തുന്നു.

## പഠന ലക്ഷ്യങ്ങൾ

ഈ ലാബ് പൂർത്തിയാക്കിയാൽ, നിങ്ങൾക്ക് കഴിയും:

- **രൂപകൽപ്പന** സങ്കീർണ്ണ പാരാമീറ്റർ സാധൂകരണം ഉള്ള പുരോഗമിച്ച MCP ടൂളുകൾ  
- **നടപ്പിലാക്കൽ** SQL ഇൻജക്ഷൻ പ്രതിരോധത്തോടെ സുരക്ഷിത ഡാറ്റാബേസ് ക്വറി ടൂളുകൾ  
- **സൃഷ്ടിക്കൽ** ഡൈനാമിക് ക്വറികൾക്കായി സ്കീമ ഇൻട്രോസ്പെക്ഷൻ കഴിവുകൾ  
- **നിർമ്മാണം** ബിസിനസ് ഇന്റലിജൻസിനായി കസ്റ്റം അനലിറ്റിക്സ് ടൂളുകൾ  
- **പ്രയോഗം** സമഗ്രമായ പിശക് കൈകാര്യം ചെയ്യലും സുഖപ്രദമായ ഡിഗ്രേഡേഷനും  
- **മെച്ചപ്പെടുത്തൽ** ഉത്പാദന വർക്ക്‌ലോഡുകൾക്കായി ടൂൾ പ്രകടനം

## 🛠️ കോർ ടൂൾ ആർക്കിടെക്ചർ

### ടൂൾ രൂപകൽപ്പന സിദ്ധാന്തങ്ങൾ
...
class BaseTool(ABC):
    ...
    async def call(self, **kwargs) -> ToolResult:
        ...
        try:
            # ഇൻപുട്ട് പാരാമീറ്ററുകൾ സാധുത പരിശോധിക്കുക
            self._validate_input(kwargs)
            
            # ടൂൾ പ്രവർത്തനം ലോഗ് ചെയ്യുക
            logger.info(
            ...
            # പ്രവർത്തന സമയം രേഖപ്പെടുത്തുക
            execution_time = (time.time() - start_time) * 1000
            result.execution_time_ms = execution_time
            self.total_execution_time += execution_time
            
            # വിജയത്തെ ലോഗ് ചെയ്യുക
            logger.info(
    ...
    def _validate_input(self, kwargs: Dict[str, Any]):
        ...
        # ടൈപ്പ് സാധുത ഇവിടെ വരും
        # പ്രൊഡക്ഷനിൽ, സമഗ്രമായ സാധുതക്കായി jsonschema ലൈബ്രറി ഉപയോഗിക്കുക
    
    def _sanitize_parameters(self, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        """Sanitize parameters for logging (remove sensitive data)."""
        
        # സენსിറ്റീവ് പാരാമീറ്ററുകൾ നീക്കം ചെയ്യുക അല്ലെങ്കിൽ മറയ്ക്കുക
...
class DatabaseTool(BaseTool):
    ...
    async def execute_query(
        ...
        async with self.get_connection() as conn:
            try:
                # നൽകിയാൽ സ്റ്റോർ കോൺടെക്സ്റ്റ് സജ്ജമാക്കുക
                if store_id:
                    await conn.execute("SELECT retail.set_store_context($1)", store_id)
                
                # ക്വറി പ്രവർത്തിപ്പിക്കുക
                start_time = time.time()
...
class QueryValidator:
    ...
    # അപകടകരമായ SQL കീവേഡുകളും പാറ്റേണുകളും
    DANGEROUS_KEYWORDS = {
    ...
    # അനുവദിച്ച വായന മാത്രം പ്രവർത്തനങ്ങൾ
    SAFE_KEYWORDS = {
    ...
    # അനുവദിച്ച സ്കീമകളും പട്ടികകളും
    ...
    def _analyze_statement(self, statement, validation_result):
        ...
        # സ്റ്റേറ്റ്മെന്റ് തരം നേടുക
        stmt_type = statement.get_type()
        
        # സ്റ്റേറ്റ്മെന്റ് തരം അനുവദനീയമാണോ എന്ന് പരിശോധിക്കുക
        if stmt_type and stmt_type.upper() not in ['SELECT', 'WITH']:
            validation_result['issues'].append(f"Disallowed statement type: {stmt_type}")
            validation_result['is_safe'] = False
            return
        
        # ടോക്കണുകൾ എടുക്കുകയും വിശകലനം ചെയ്യുകയും ചെയ്യുക
    ...
    def _validate_table_access(self, query: str, validation_result):
        ...
        # പട്ടിക നാമങ്ങൾ എടുക്കുക (സരളമായ സമീപനം)
        # പ്രൊഡക്ഷനിൽ, ശരിയായ SQL പാഴ്‌സിംഗ് ഉപയോഗിക്കുക
        ...
        for table_ref in all_tables:
            if '.' in table_ref:
                ...
                # വ്യക്തമാക്കിയിട്ടില്ലെങ്കിൽ റീട്ടെയിൽ സ്കീമ فرضിക്കുക
...
# ഗ്ലോബൽ വാലിഡേറ്റർ ഇൻസ്റ്റൻസ്
query_validator = QueryValidator()
```

## 🗃️ ഡാറ്റാബേസ് ക്വറി ടൂളുകൾ
...
class SalesAnalysisTool(DatabaseTool):
    ...
    def __init__(self, db_provider):
        ...
        # സാധാരണ വിശകലനത്തിനുള്ള മുൻകൂട്ടി നിർമ്മിച്ച ക്വറി ടെംപ്ലേറ്റുകൾ
    ...
    async def _execute_custom_query(self, kwargs: Dict[str, Any]) -> ToolResult:
        ...
        # സുരക്ഷയ്ക്കായി ക്വറി സാധുത പരിശോധിക്കുക
        ...
        # സാധുതയുള്ള ക്വറി നടപ്പിലാക്കുക
...
class SchemaIntrospectionTool(DatabaseTool):
    ...
    async def _get_single_table_schema(
        ...
        async with self.get_connection() as conn:
            ...
            # ആവശ്യപ്പെട്ടാൽ നിയന്ത്രണങ്ങൾ നേടുക
            ...
            # ആവശ്യപ്പെട്ടാൽ പട്ടിക സ്ഥിതിവിവരക്കണക്കുകൾ നേടുക
    ...
    async def _get_all_tables_schema(
        ...
        async with self.get_connection() as conn:
            # റീട്ടെയിൽ സ്കീമയിലെ എല്ലാ പട്ടികകളും നേടുക
            tables_query = """
                SELECT 
                    table_name,
                    table_type
            ...
            for table in tables:
                ...
                # ഓരോ പട്ടികയ്ക്കും കോളങ്ങൾ നേടുക
                columns_query = """
                    SELECT 
                        column_name,
                        data_type,
...
## 📊 അനലിറ്റിക്സ് ആൻഡ് യൂട്ടിലിറ്റി ടൂളുകൾ

### ബിസിനസ് ഇന്റലിജൻസ് ടൂൾ
...
class BusinessIntelligenceTool(DatabaseTool):
    ...
    async def _generate_business_summary(self, kwargs: Dict[str, Any]) -> ToolResult:
        ...
        if result.success and result.data:
            ...
            # ഉത്പന്നമായ洞ന്വേഷണങ്ങൾ ചേർക്കുക
            insights = {
                'revenue_trend': 'stable',  # ചരിത്ര ഡാറ്റയുടെ അടിസ്ഥാനത്തിൽ കണക്കാക്കും
...
✅ **പുരോഗമിച്ച ടൂൾ ആർക്കിടെക്ചർ**: സമഗ്രമായ പിശക് കൈകാര്യം ചെയ്യലോടെ സങ്കീർണ്ണ MCP ടൂളുകൾ നടപ്പിലാക്കി  
✅ **ക്വറി സാധൂകരണം**: ഇൻജക്ഷൻ ആക്രമണങ്ങൾ തടയാൻ സുരക്ഷിത SQL സാധൂകരണം നിർമ്മിച്ചു  
✅ **ഡാറ്റാബേസ് ടൂളുകൾ**: ശക്തമായ വിൽപ്പന വിശകലനവും സ്കീമ ഇൻട്രോസ്പെക്ഷൻ കഴിവുകളും സൃഷ്ടിച്ചു  
✅ **ബിസിനസ് ഇന്റലിജൻസ്**: സമഗ്രമായ ബിസിനസ്洞察ങ്ങൾക്കായി അനലിറ്റിക്സ് ടൂളുകൾ വികസിപ്പിച്ചു  
✅ **പ്രകടന മെച്ചപ്പെടുത്തൽ**: കാഷിംഗ്, കണക്ഷൻ പൂളിംഗ്, ക്വറി മെച്ചപ്പെടുത്തൽ പ്രയോഗിച്ചു  
✅ **സുരക്ഷാ സംയോജനം**: റോള്ബേസ് ആക്സസ് നിയന്ത്രണവും ഓഡിറ്റ് ലോഗിംഗും നടപ്പിലാക്കി  

## 🚀 അടുത്തത് എന്താണ്

**[Lab 07: Semantic Search Integration](../07-Semantic-Search/README.md)** തുടരണം:

- MCP ടൂളുകളുമായി വെക്ടർ സെർച്ച് കഴിവുകൾ സംയോജിപ്പിക്കുക  
- സെമാന്റിക് ഉൽപ്പന്ന സെർച്ച് ഫംഗ്ഷനാലിറ്റി നിർമ്മിക്കുക  
- എഐ-ശക്തിയുള്ള ക്വറി മനസ്സിലാക്കൽ നടപ്പിലാക്കുക  
- പരമ്പരാഗതവും വെക്ടർ ക്വറികളും സംയോജിപ്പിക്കുന്ന ഹൈബ്രിഡ് സെർച്ച് സൃഷ്ടിക്കുക  

## 📚 അധിക സ്രോതസുകൾ

### MCP ടൂൾ വികസനം
- [Model Context Protocol Documentation](https://modelcontextprotocol.io/docs) - ഔദ്യോഗിക MCP സ്പെസിഫിക്കേഷൻ  
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - പൈതൺ MCP നടപ്പാക്കൽ  
- [MCP Tool Patterns](https://github.com/modelcontextprotocol/servers) - ഉദാഹരണ ടൂൾ നടപ്പാക്കലുകൾ  

### ഡാറ്റാബേസ് സുരക്ഷ
- [SQL Injection Prevention](https://owasp.org/www-community/attacks/SQL_Injection) - OWASP സുരക്ഷാ ഗൈഡ്  
- [PostgreSQL Security](https://www.postgresql.org/docs/current/security.html) - ഡാറ്റാബേസ് സുരക്ഷാ മികച്ച പ്രാക്ടീസുകൾ  
- [Query Validation Techniques](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - സുരക്ഷിത ക്വറി മാതൃകകൾ  

### പ്രകടന മെച്ചപ്പെടുത്തൽ
- [Database Query Optimization](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL പ്രകടന ഗൈഡ്  
...
- [Async Python Patterns](https://docs.python.org/3/library/asyncio.html) - അസിങ്ക്രണസ് പ്രോഗ്രാമിംഗ് ഗൈഡ്  

---

**മുൻപ്**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
**അടുത്തത്**: [Lab 07: Semantic Search Integration](../07-Semantic-Search/README.md)
