...
1. **Pridajte konfiguráciu MCP:**
   ...
   ![Krok 1: Pridajte mcp.json do priečinka .vscode](../../../../../../translated_images/sk/step1-mcp-json.c06a007fccc3edfa.webp)
...
2. **Otvorte panel GitHub Copilot Chat:**
   ...
   ![Krok 2: Otvorte panel Copilot Chat](../../../../../../translated_images/sk/step2-copilot-panel.f1cc86e9b9b8cd1a.webp)

3. **Povoľte agent mód a overte nástroje:**
   V paneli Copilot Chat povoľte agent mód.

   ![Krok 3: Povoľte agent mód a overte nástroje](../../../../../../translated_images/sk/step3-agent-mode.cdc32520fd7dd1d1.webp)
   ...
   ![Krok 3: Overenie nástroja MCP server](../../../../../../translated_images/sk/step3-verify-mcp-tool.76096a6329cbfecd.webp)
4. **Začnite nový chat a položte agentovi otázku:**
   ...
   ![Krok 4: Položte agentovi otázku v chate](../../../../../../translated_images/sk/step4-prompt-chat.12187bb001605efc.webp)
