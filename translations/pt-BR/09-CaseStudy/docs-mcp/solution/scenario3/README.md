...
1. **Adicione a configuração do MCP:**  
   ...
   ![Passo 1: Adicione o mcp.json na pasta .vscode](../../../../../../translated_images/pt-BR/step1-mcp-json.c06a007fccc3edfa.webp)
...
2. **Abra o painel do GitHub Copilot Chat:**  
   ...
   ![Passo 2: Abra o painel do Copilot Chat](../../../../../../translated_images/pt-BR/step2-copilot-panel.f1cc86e9b9b8cd1a.webp)
