...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-11T12:48:21+00:00",
...
ఇది MCP సర్వర్ కోసం ఒక Typescript నమూనా

క్యాల్క్యులేటర్ భాగం ఇలా ఉంటుంది:

```typescript
// ప్రతి ఆపరేషన్ కోసం క్యాల్క్యులేటర్ టూల్స్ నిర్వచించండి
server.tool(
  "add",
  {
    a: z.number(),
