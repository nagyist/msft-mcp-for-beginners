...
![Visual Studio Code లో గైడెడ్ MCP సర్వర్ కాన్ఫిగరేషన్](../../../../translated_images/te/chat-mode-agent.729a22473f822216.webp)
![ఏజెంట్ సెషన్‌కు టూల్ ఎంపిక](../../../../translated_images/te/agent-mode-select-tools.522c7ba5df0848f8.webp)
![MCP అభివృద్ధి సమయంలో సులభంగా లోపాలను డీబగ్ చేయడం](../../../../translated_images/te/mcp-list-servers.fce89eefe3f30032.webp)
...
1. ఒక టూల్ నడపడానికి, మీ టూల్స్ వివరణకు సరిపోయే ప్రాంప్ట్ టైప్ చేయండి, ఉదాహరణకు "add 22 to 1" వంటి ప్రాంప్ట్:
  ...
  ![GitHub Copilot నుండి టూల్ నడపడం](../../../../translated_images/te/vscode-agent.d5a0e0b897331060.webp)
