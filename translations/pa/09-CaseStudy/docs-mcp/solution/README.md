ਇਹਾਂ ਹਰ ਰਨਟਾਈਮ ਲਈ ਹੱਲ ਹਨ:
- [Python](./python/README.md)

ਇਨ-ਐਡੀਟਰ ਦਸਤਾਵੇਜ਼ੀਕਰਨ ਅਤੇ Copilot ਇੰਟੀਗ੍ਰੇਸ਼ਨ ਲਈ, ਵੇਖੋ [Scenario 3: In-Editor Docs with MCP Server in VS Code](./scenario3/README.md) (ਕਿਸੇ ਵੀ ਰਨਟਾਈਮ ਨਾਲ ਕੰਮ ਕਰਦਾ ਹੈ)।
