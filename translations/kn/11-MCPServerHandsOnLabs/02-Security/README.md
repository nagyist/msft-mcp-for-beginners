...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-11T14:42:09+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "kn"
}
-->
# ಭದ್ರತೆ ಮತ್ತು ಬಹು-ಭಾಡಿಗೆತನ

## 🎯 ಈ ಪ್ರಯೋಗಶಾಲೆ ಏನು ಒಳಗೊಂಡಿದೆ

ಈ ಪ್ರಯೋಗಶಾಲೆ MCP ಸರ್ವರ್‌ಗಳಿಗೆ ಎಂಟರ್‌ಪ್ರೈಸ್-ಗ್ರೇಡ್ ಭದ್ರತೆ ಮತ್ತು ಬಹು-ಭಾಡಿಗೆತನವನ್ನು ಅನುಷ್ಠಾನಗೊಳಿಸುವ ಕುರಿತು ಸಮಗ್ರ ಮಾರ್ಗದರ್ಶನವನ್ನು ಒದಗಿಸುತ್ತದೆ. ನೀವು ಬಹು-ಭಾಡಿಗೆಯವರ ನಡುವೆ ಲವಚಿಕ ಪ್ರವೇಶ ಮಾದರಿಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸುವಾಗ ಸಂವೇದನಾಶೀಲ ಚಿಲ್ಲರೆ ಡೇಟಾವನ್ನು ರಕ್ಷಿಸುವ ಸುರಕ್ಷಿತ, ಅನುಕೂಲಕರ ವ್ಯವಸ್ಥೆಗಳನ್ನು ವಿನ್ಯಾಸಗೊಳಿಸುವುದನ್ನು ಕಲಿಯುತ್ತೀರಿ.

## ಅವಲೋಕನ

ಗ್ರಾಹಕ ಡೇಟಾ, ಪಾವತಿ ಮಾಹಿತಿ ಮತ್ತು ವ್ಯವಹಾರ ಬುದ್ಧಿವಂತಿಕೆಯನ್ನು ನಿರ್ವಹಿಸುವ ಚಿಲ್ಲರೆ ಅಪ್ಲಿಕೇಶನ್‌ಗಳಲ್ಲಿ ಭದ್ರತೆ ಅತ್ಯಂತ ಮುಖ್ಯವಾಗಿದೆ. ಈ ಪ್ರಯೋಗಶಾಲೆ ಪ್ರಾಮಾಣೀಕರಣ ಮತ್ತು ಪ್ರಾಧಿಕಾರದಿಂದ ಡೇಟಾ ವಿಭಜನೆ ಮತ್ತು ಅನುಕೂಲತೆ ಮೇಲ್ವಿಚಾರಣೆಯವರೆಗೆ ಸಂಪೂರ್ಣ ಭದ್ರತಾ ವಾಸ್ತುಶಿಲ್ಪವನ್ನು ಒಳಗೊಂಡಿದೆ.

ನಾವು Azure ಗುರುತಿನ ಸೇವೆಗಳು, PostgreSQL ರೋ ಲೆವೆಲ್ ಸೆಕ್ಯುರಿಟಿ, ಅಪ್ಲಿಕೇಶನ್-ಮಟ್ಟದ ನಿಯಂತ್ರಣಗಳು ಮತ್ತು ಸಮಗ್ರ ಆಡಿಟ್ ಲಾಗಿಂಗ್ ಅನ್ನು ಸಂಯೋಜಿಸುವ ಮೂಲಕ ಗಟ್ಟಿಯಾದ, ಅನುಕೂಲಕರ ವೇದಿಕೆಯನ್ನು ರಚಿಸುವ ರಕ್ಷಣಾ-ಆಳತೆಯ ತಂತ್ರವನ್ನು ಅನುಷ್ಠಾನಗೊಳಿಸುತ್ತೇವೆ.

## ಕಲಿಕೆಯ ಉದ್ದೇಶಗಳು

ಈ ಪ್ರಯೋಗಶಾಲೆಯ ಅಂತ್ಯಕ್ಕೆ, ನೀವು ಸಾಧ್ಯವಾಗುತ್ತದೆ:

- **ಅನುಷ್ಠಾನಗೊಳಿಸುವುದು** ಬಹು-ಭಾಡಿಗೆಯ ಡೇಟಾ ವಿಭಜನೆಗಾಗಿ ಎಂಟರ್‌ಪ್ರೈಸ್-ಗ್ರೇಡ್ ರೋ ಲೆವೆಲ್ ಸೆಕ್ಯುರಿಟಿ  
- **ವಿನ್ಯಾಸಗೊಳಿಸುವುದು** Azure ಜೊತೆಗೆ ಸುರಕ್ಷಿತ ಪ್ರಾಮಾಣೀಕರಣ ಮತ್ತು ಪ್ರಾಧಿಕಾರ ಮಾದರಿಗಳನ್ನು  
- **ಕಾನ್ಫಿಗರ್ ಮಾಡುವುದು** ಅನುಕೂಲತೆ ಅಗತ್ಯಗಳಿಗೆ ಸಮಗ್ರ ಆಡಿಟ್ ಲಾಗಿಂಗ್  
- **ಅನ್ವಯಿಸುವುದು** ಎಲ್ಲಾ ಅಪ್ಲಿಕೇಶನ್ ಪದರಗಳಲ್ಲಿ ರಕ್ಷಣಾ-ಆಳತೆಯ ಭದ್ರತಾ ತಂತ್ರಗಳನ್ನು  
- **ಮಾನ್ಯತೆ ಮಾಡುವುದು** ವ್ಯವಸ್ಥಿತ ಪರೀಕ್ಷೆ ಮೂಲಕ ಭದ್ರತಾ ಅನುಷ್ಠಾನಗಳನ್ನು  
- **ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡುವುದು** ಭದ್ರತಾ ಘಟನೆಗಳನ್ನು ಮತ್ತು ಸಾಧ್ಯತೆಯಿರುವ ಬೆದರಿಕೆಗಳಿಗೆ ಪ್ರತಿಕ್ರಿಯಿಸುವುದು  

## 🔐 ಬಹು-ಭಾಡಿಗೆತನ ಭದ್ರತಾ ವಾಸ್ತುಶಿಲ್ಪ
...
### ಬಹು-ಭಾಡಿಗೆತನ ಮಾದರಿಗಳು

ನಮ್ಮ ಅನುಷ್ಠಾನವು ರೋ ಲೆವೆಲ್ ಸೆಕ್ಯುರಿಟಿ ಹೊಂದಿರುವ **ಹಂಚಿಕೊಂಡ ಡೇಟಾಬೇಸ್, ಹಂಚಿಕೊಂಡ ಸ್ಕೀಮಾ** ಮಾದರಿಯನ್ನು ಬಳಸುತ್ತದೆ:

**ಲಾಭಗಳು:**  
- ವೆಚ್ಚ-ಕಾರ್ಯಕ್ಷಮ ಸಂಪನ್ಮೂಲ ಬಳಕೆ  
- ಸರಳೀಕೃತ ನಿರ್ವಹಣೆ ಮತ್ತು ನವೀಕರಣಗಳು  
- RLS ಮೂಲಕ ಬಲವಾದ ಡೇಟಾ ವಿಭಜನೆ  
- ಅನುಕೂಲತೆ-ಸ್ನೇಹಿ ಆಡಿಟ್ ಟ್ರೇಲ್ಸ್  

**ವ್ಯವಹಾರಗಳು:**  
- RLS ನೀತಿ ವಿನ್ಯಾಸದಲ್ಲಿ ಜಾಗರೂಕತೆ ಅಗತ್ಯ  
- ಸ್ಕೀಮಾ ಬದಲಾವಣೆಗಳು ಎಲ್ಲಾ ಭಾಡಿಗೆಯವರ ಮೇಲೆ ಪರಿಣಾಮ ಬೀರುತ್ತವೆ  
- ಬಲವಾದ ಬ್ಯಾಕಪ್/ಪುನಃಸ್ಥಾಪನೆ ಪ್ರಕ್ರಿಯೆಗಳ ಅಗತ್ಯ  

## 🛡️ ರೋ ಲೆವೆಲ್ ಸೆಕ್ಯುರಿಟಿ ಅನುಷ್ಠಾನ
...
class AzureAuthenticator:
    ...
    def __init__(self):
        ...
        # JWKS (JSON ವೆಬ್ ಕೀ ಸೆಟ್) ಗಾಗಿ ಕ್ಯಾಶೆ
        self._jwks_cache = None
        self._jwks_cache_expiry = None
        
        # ರಹಸ್ಯಗಳಿಗಾಗಿ ಕೀ ವಾಲ್ಟ್
    ...
    async def validate_token(self, token: str) -> Dict:
        ...
        try:
            # ಸಹಿ ಹಾಕುವ ಕೀಗಳನ್ನು ಪಡೆಯಿರಿ
            signing_keys = await self._get_signing_keys()
            
            # ಕೀ ID ಪಡೆಯಲು ಟೋಕನ್ ಹೆಡರ್ ಡಿಕೋಡ್ ಮಾಡಿ
            ...
            # ಟೋಕನ್ ಮಾನ್ಯತೆ ಮಾಡಿ ಮತ್ತು ಡಿಕೋಡ್ ಮಾಡಿ
            payload = jwt.decode(
                token,
                signing_key,
                algorithms=['RS256'],
            ...
            # ಬಳಕೆದಾರ ಮಾಹಿತಿಯನ್ನು ಹೊರತೆಗೆಯಿರಿ
            user_info = self._extract_user_info(payload)
            
            # ಯಶಸ್ವಿ ಪ್ರಮಾಣೀಕರಣವನ್ನು ಲಾಗ್ ಮಾಡಿ
            logger.info(
    ...
    async def get_user_store_access(self, user_id: str) -> List[str]:
        ...
        try:
            # ಇದು ಸಾಮಾನ್ಯವಾಗಿ ನಿಮ್ಮ ಬಳಕೆದಾರ/ಸ್ಟೋರ್ ನಕ್ಷೆಗಳನ್ನು ಪ್ರಶ್ನಿಸುತ್ತದೆ
            # ಡೆಮೊಗಾಗಿ, ನಾವು ಸರಳ ಕೀ ವಾಲ್ಟ್ ರಹಸ್ಯವನ್ನು ಬಳಸುತ್ತೇವೆ
            ...
            # ಬ್ಯಾಕಪ್: ಡೀಫಾಲ್ಟ್ ಸ್ಟೋರ್ ಪ್ರವೇಶವನ್ನು ಹಿಂತಿರುಗಿಸಿ
            logger.warning(f"No store mapping found for user {user_id}, using default")
            return ['seattle']  # ಡೀಫಾಲ್ಟ್ ಸ್ಟೋರ್ ಪ್ರವೇಶ
            
        except Exception as e:
            logger.error(f"Failed to get store access for user {user_id}: {e}")
            return []  # ಸ್ಟೋರ್‌ಗಳನ್ನು ನಿರ್ಧರಿಸಲು ಸಾಧ್ಯವಾಗದಿದ್ದರೆ ಪ್ರವೇಶವಿಲ್ಲ

# ಗ್ಲೋಬಲ್ ಪ್ರಮಾಣೀಕರಣದ ಉದಾಹರಣೆ
...
class RoleBasedAuth:
    ...
    # ಪಾತ್ರ ಹಿರಾರ್ಕಿಯನ್ನು ವ್ಯಾಖ್ಯಾನಿಸಿ
    ROLE_HIERARCHY = {
    ...
    # ಪ್ರತಿ ಪಾತ್ರಕ್ಕೆ ಅನುಮತಿಗಳನ್ನು ವ್ಯಾಖ್ಯಾನಿಸಿ
    ROLE_PERMISSIONS = {
        'store_admin': [
    ...
    def get_user_stores(cls, user_info: Dict) -> List[str]:
        ...
        # ಇದು ಸಾಮಾನ್ಯವಾಗಿ ನಿಮ್ಮ ಬಳಕೆದಾರ ನಿರ್ವಹಣಾ ವ್ಯವಸ್ಥೆಯಿಂದ ಬರುತ್ತದೆ
        # ಡೆಮೊಗಾಗಿ, ನಾವು ಕಸ್ಟಮ್ ಕ್ಲೇಮ್ಸ್ ಅಥವಾ ಗುಂಪುಗಳಿಂದ ತೆಗೆದುಕೊಳ್ಳುತ್ತೇವೆ
        
        stores = []
        
        # ಗುಂಪುಗಳಲ್ಲಿ ನೇರ ಅಂಗಡಿ ನಿಯೋಜನೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ
        for group in user_info.get('groups', []):
            if group.startswith('store_'):
                store_id = group.replace('store_', '')
                stores.append(store_id)
        
        # ಅಪ್ಲಿಕೇಶನ್-ನಿರ್ದಿಷ್ಟ ಪಾತ್ರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ
        for role in user_info.get('app_roles', []):
            if 'store:' in role:
                _, store_id = role.split('store:', 1)
                stores.append(store_id)
        
        return list(set(stores))  # ನಕಲುಗಳನ್ನು ತೆಗೆದುಹಾಕಿ
...
def require_auth(required_permission: str = None, require_store_access: bool = True):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            # ಅರ್ಗ್‌ಗಳಿಂದ ವಿನಂತಿಯನ್ನು ತೆಗೆದುಹಾಕಿ (ಫಾಸ್ಟ್‌ಎಪಿಐ ಅವಲಂಬನೆ ಇಂಜೆಕ್ಷನ್)
            request = None
            for arg in args:
            ...
            try:
                ...
                if require_store_access:
                    ...
                    # ಡೀಫಾಲ್ಟ್ ಅಂಗಡಿ ಸನ್ನಿವೇಶವನ್ನು ಹೊಂದಿಸಿ (ಮೊದಲ ಪ್ರವೇಶಿಸಬಹುದಾದ ಅಂಗಡಿ)
                    request.state.current_store = user_stores[0]
                    request.state.accessible_stores = user_stores
                
                # ಬಳಕೆದಾರ ಮಾಹಿತಿಯನ್ನು ವಿನಂತಿ ಸ್ಥಿತಿಗೆ ಸೇರಿಸಿ
                request.state.user_info = user_info
                request.state.user_id = user_info['user_id']
                
                # ಮೂಲ ಕಾರ್ಯವನ್ನು ಕರೆ ಮಾಡಿ
...
def require_store_context(store_param: str = 'store_id'):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            # ಅರ್ಗ್‌ಗಳಿಂದ ವಿನಂತಿಯನ್ನು ತೆಗೆದುಹಾಕಿ
            request = None
            for arg in args:
                if isinstance(arg, Request):
                    request = arg
            ...
            # ಬಳಕೆದಾರನಿಗೆ ವಿನಂತಿಸಿದ ಅಂಗಡಿಗೆ ಪ್ರವೇಶವಿದೆಯೇ ಎಂದು ಮಾನ್ಯತೆ ಮಾಡಿ
            ...
            # ವಿನಂತಿ ಸ್ಥಿತಿಯಲ್ಲಿ ಅಂಗಡಿ ಸನ್ನಿವೇಶವನ್ನು ಹೊಂದಿಸಿ
...
class SecurityMonitor:
    ...
    def __init__(self, db_connection_string: str):
        ...
        # ಎಚ್ಚರಿಕೆ ಗಡಿಬಿಡಿಗಳು
        self.thresholds = {
            'failed_auth_attempts': 5,      # ಪ್ರತಿ ಬಳಕೆದಾರ ಪ್ರತಿ ಗಂಟೆಗೆ
            'multiple_ip_access': 3,        # ಪ್ರತಿ ಬಳಕೆದಾರ ಪ್ರತಿ ಗಂಟೆಗೆ ವಿಭಿನ್ನ IP ಗಳು
            'excessive_data_access': 1000,  # ಪ್ರತಿ ಬಳಕೆದಾರ ಪ್ರತಿ ಗಂಟೆಗೆ ಪ್ರಶ್ನೆಗಳು
            'privilege_escalation': 1,      # ಯಾವುದೇ ಪ್ರಯತ್ನ
            'unauthorized_store_access': 1  # ಯಾವುದೇ ಪ್ರಯತ್ನ
        }
    ...
    async def start_monitoring(self):
        ...
        while True:
            try:
                ...
                await asyncio.sleep(300)  # ಪ್ರತಿ 5 ನಿಮಿಷಗಳಿಗೆ ಪರಿಶೀಲಿಸಿ
            except Exception as e:
                logger.error(f"Security monitoring error: {e}")
                await asyncio.sleep(60)  # ದೋಷದ ಮೇಲೆ ಚಿಕ್ಕ ಮರುಪ್ರಯತ್ನ
    ...
    async def _check_security_events(self):
        ...
        try:
            # ವಿಫಲ ಪ್ರಮಾಣೀಕರಣ ಪ್ರಯತ್ನಗಳನ್ನು ಪರಿಶೀಲಿಸಿ
            await self._check_failed_auth(conn)
            
            # ಸಂಶಯಾಸ್ಪದ ಪ್ರವೇಶ ಮಾದರಿಗಳನ್ನು ಪರಿಶೀಲಿಸಿ
            await self._check_suspicious_access(conn)
            
            # ಡೇಟಾ ಪ್ರವೇಶ ಅಸಾಮಾನ್ಯತೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ
            await self._check_data_access_anomalies(conn)
            
            # ಅನಧಿಕೃತ ಪ್ರವೇಶ ಪ್ರಯತ್ನಗಳನ್ನು ಪರಿಶೀಲಿಸಿ
    ...
    async def _send_alert(self, alert: SecurityAlert):
        ...
        # ಸಂರಚಿತ ಎಚ್ಚರಿಕೆ ಹ್ಯಾಂಡ್ಲರ್‌ಗಳಿಗೆ ಕಳುಹಿಸಿ
...
## 🧪 ಭದ್ರತಾ ಪರೀಕ್ಷೆ ಮತ್ತು ಮಾನ್ಯತೆ

### ಸ್ವಯಂಚಾಲಿತ ಭದ್ರತಾ ಪರೀಕ್ಷೆಗಳು
...
class TestRowLevelSecurity:
    ...
    async def test_store_context_isolation(self, db_connection):
        ...
        # ವಿಭಜನೆ ಪರಿಶೀಲಿಸಿ (ಎಣಿಕೆಗಳು ವಿಭಿನ್ನವಾಗಿರಬೇಕು)
    ...
    async def test_cross_store_data_leakage(self, db_connection):
        ...
        # ಒಂದು ಅಂಗಡಿಗೆ ಸನ್ನಿವೇಶವನ್ನು ಹೊಂದಿಸಿ
        await db_connection.execute("SELECT retail.set_store_context('seattle')")
        
        # ವಿಭಿನ್ನ store_id ಜೊತೆಗೆ ಡೇಟಾವನ್ನು ಸೇರಿಸಲು ಪ್ರಯತ್ನಿಸಿ
...
class TestAuthentication:
    ...
    def test_valid_jwt_token(self):
        ...
        # ಇದಕ್ಕೆ JWKS ಎಂಡ್ಪಾಯಿಂಟ್ ನಕಲಿ ಮಾಡಬೇಕಾಗುತ್ತದೆ
        # ನಿಜವಾದ ಅನುಷ್ಠಾನದಲ್ಲಿ, ಸರಿಯಾದ ಪರೀಕ್ಷಾ JWT ಟೋಕನ್‌ಗಳನ್ನು ಬಳಸಿ
    ...
    def test_expired_token_rejection(self):
        ...
        token_payload = {
            'oid': 'user-123',
            'exp': int((datetime.now(timezone.utc)).timestamp()) - 3600,  # ಅವಧಿ ಮುಗಿದಿದೆ
            'iat': int((datetime.now(timezone.utc)).timestamp()) - 7200
        }
        
        # ಪರೀಕ್ಷೆ ಅವಧಿ ಮುಗಿದ ಟೋಕನ್‌ಗಳು ತಿರಸ್ಕರಿಸಲ್ಪಡುವುದನ್ನು ಪರಿಶೀಲಿಸುತ್ತದೆ
    ...
    def test_invalid_audience_rejection(self):
        ...
        token_payload = {
            'oid': 'user-123',
            'aud': 'wrong-audience',  # ಅಮಾನ್ಯ ಪ್ರೇಕ್ಷಕ
            'exp': int((datetime.now(timezone.utc)).timestamp()) + 3600,
            'iat': int((datetime.now(timezone.utc)).timestamp())
        }
        
        # ಪರೀಕ್ಷೆ ತಪ್ಪು ಪ್ರೇಕ್ಷಕ ಟೋಕನ್‌ಗಳು ತಿರಸ್ಕರಿಸಲ್ಪಡುವುದನ್ನು ಪರಿಶೀಲಿಸುತ್ತದೆ
...
class TestAuthorization:
    ...
    def test_role_hierarchy(self):
        ...
        # ಅಂಗಡಿ ನಿರ್ವಾಹಕನಿಗೆ ಎಲ್ಲಾ ಅನುಮತಿಗಳು ಇರಬೇಕು
        ...
        # ಅಂಗಡಿ ಬಳಕೆದಾರನಿಗೆ ಸೀಮಿತ ಅನುಮತಿಗಳು ಇರಬೇಕು
        ...
        # ಅಂಗಡಿ ಓದಲು ಮಾತ್ರ ಅನುಮತಿಗಳು ಕನಿಷ್ಠವಾಗಿರಬೇಕು
    ...
    def test_permission_inheritance(self):
        ...
        # ವ್ಯವಸ್ಥಾಪಕನು ಬಳಕೆದಾರ ಅನುಮತಿಗಳನ್ನು ವಂಶಪಾರಂಪರ್ಯವಾಗಿ ಪಡೆಯಬೇಕು
...
# ಭದ್ರತಾ ಪರೀಕ್ಷಾ ರನ್ನರ್
if __name__ == "__main__":
    pytest.main([__file__, "-v"])
```

### ಪೆನೆಟ್ರೇಶನ್ ಪರೀಕ್ಷೆ ಪರಿಶೀಲನಾ ಪಟ್ಟಿ
...
✅ **ಬಹು-ಭಾಡಿಗೆತನ ಭದ್ರತೆ**: ಸಂಪೂರ್ಣ ಡೇಟಾ ವಿಭಜನೆಗಾಗಿ ರೋ ಲೆವೆಲ್ ಸೆಕ್ಯುರಿಟಿ ಅನುಷ್ಠಾನಗೊಳಿಸಲಾಗಿದೆ  
✅ **Azure ಪ್ರಾಮಾಣೀಕರಣ**: JWT ಮಾನ್ಯತೆ ಜೊತೆಗೆ Azure Entra ID ಏಕೀಕೃತವಾಗಿದೆ  
✅ **ಪಾತ್ರಾಧಾರಿತ ಪ್ರಾಧಿಕಾರ**: ಹಿರಾರ್ಕಿಕಲ್ ಪಾತ್ರ ಮತ್ತು ಅನುಮತಿ ವ್ಯವಸ್ಥೆಯನ್ನು ಕಾನ್ಫಿಗರ್ ಮಾಡಲಾಗಿದೆ  
✅ **ಸಮಗ್ರ ಆಡಿಟ್ ಲಾಗಿಂಗ್**: ಭದ್ರತಾ ಘಟನೆಗಳ ಟ್ರ್ಯಾಕಿಂಗ್ ಮತ್ತು ಮೇಲ್ವಿಚಾರಣೆಯನ್ನು ಸ್ಥಾಪಿಸಲಾಗಿದೆ  
✅ **ಭದ್ರತಾ ಪರೀಕ್ಷೆ**: ಸ್ವಯಂಚಾಲಿತ ಭದ್ರತಾ ಮಾನ್ಯತೆ ಪರೀಕ್ಷೆಗಳನ್ನು ಅನುಷ್ಠಾನಗೊಳಿಸಲಾಗಿದೆ  
✅ **ಬೆದರಿಕೆ ಮೇಲ್ವಿಚಾರಣೆ**: ನೈಜ-ಸಮಯ ಭದ್ರತಾ ಘಟನೆ ಪತ್ತೆ ಮತ್ತು ಎಚ್ಚರಿಕೆ ವ್ಯವಸ್ಥೆಯನ್ನು ರಚಿಸಲಾಗಿದೆ  

## 🚀 ಮುಂದೇನು

**[Lab 03: Environment Setup](../03-Setup/README.md)** ಜೊತೆಗೆ ಮುಂದುವರಿಯಿರಿ:

- ಭದ್ರತಾ ಉತ್ತಮ ಅಭ್ಯಾಸಗಳೊಂದಿಗೆ ಅಭಿವೃದ್ಧಿ ಪರಿಸರಗಳನ್ನು ಕಾನ್ಫಿಗರ್ ಮಾಡುವುದು  
- ಪ್ರಾಮಾಣೀಕರಣ ಮತ್ತು ಮೇಲ್ವಿಚಾರಣೆಗೆ Azure ಸೇವೆಗಳನ್ನು ಸ್ಥಾಪಿಸುವುದು  
- ಸುರಕ್ಷಿತ ಡೇಟಾಬೇಸ್ ಸಂಪರ್ಕಗಳು ಮತ್ತು ರಹಸ್ಯ ನಿರ್ವಹಣೆಯನ್ನು ಅನುಷ್ಠಾನಗೊಳಿಸುವುದು  
- ಅಭಿವೃದ್ಧಿ ಪರಿಸರಗಳಲ್ಲಿ ಭದ್ರತಾ ಸಂರಚನೆಗಳನ್ನು ಮಾನ್ಯತೆ ಮಾಡುವುದು  

## 📚 ಹೆಚ್ಚುವರಿ ಸಂಪನ್ಮೂಲಗಳು

### Azure ಭದ್ರತೆ  
- [Azure Entra ID ಡಾಕ್ಯುಮೆಂಟೇಶನ್](https://docs.microsoft.com/azure/active-directory/) - ಸಂಪೂರ್ಣ ಗುರುತಿನ ವೇದಿಕೆ ಮಾರ್ಗದರ್ಶಿ  
- [Azure ಕೀ ವಾಲ್ಟ್](https://docs.microsoft.com/azure/key-vault/) - ರಹಸ್ಯ ನಿರ್ವಹಣಾ ಸೇವೆ  
- [Azure ಭದ್ರತಾ ಉತ್ತಮ ಅಭ್ಯಾಸಗಳು](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - ಭದ್ರತಾ ಮಾರ್ಗದರ್ಶನ  

### ಡೇಟಾಬೇಸ್ ಭದ್ರತೆ  
- [PostgreSQL ರೋ ಲೆವೆಲ್ ಸೆಕ್ಯುರಿಟಿ](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - ಅಧಿಕೃತ RLS ಡಾಕ್ಯುಮೆಂಟೇಶನ್  
- [ಡೇಟಾಬೇಸ್ ಭದ್ರತಾ ಪರಿಶೀಲನಾ ಪಟ್ಟಿ](https://www.postgresql.org/docs/current/security.html) - PostgreSQL ಭದ್ರತಾ ಮಾರ್ಗದರ್ಶಿ  
- [ಬಹು-ಭಾಡಿಗೆತನ ಡೇಟಾಬೇಸ್ ಮಾದರಿಗಳು](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - ವಾಸ್ತುಶಿಲ್ಪ ಮಾದರಿಗಳು  

### ಭದ್ರತಾ ಪರೀಕ್ಷೆ  
- [OWASP ಪರೀಕ್ಷಾ ಮಾರ್ಗದರ್ಶಿ](https://owasp.org/www-project-web-security-testing-guide/) - ಸಮಗ್ರ ಭದ್ರತಾ ಪರೀಕ್ಷೆ  
- [JWT ಭದ್ರತಾ ಉತ್ತಮ ಅಭ್ಯಾಸಗಳು](https://tools.ietf.org/html/rfc8725) - JWT ಭದ್ರತಾ ಪರಿಗಣನೆಗಳು  
- [API ಭದ್ರತಾ ಪರೀಕ್ಷೆ](https://owasp.org/www-project-api-security/) - API-ನಿರ್ದಿಷ್ಟ ಭದ್ರತಾ ಪರೀಕ್ಷೆ  

---

**ಹಿಂದಿನ**: [Lab 01: Core Architecture Concepts](../01-Architecture/README.md)  
**ಮುಂದಿನ**: [Lab 03: Environment Setup](../03-Setup/README.md)
