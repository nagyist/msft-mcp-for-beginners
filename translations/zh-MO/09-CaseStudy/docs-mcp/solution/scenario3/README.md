...
1. **新增 MCP 設定：**  
   ...
   ![步驟 1：將 mcp.json 加入 .vscode 資料夾](../../../../../../translated_images/zh-MO/step1-mcp-json.c06a007fccc3edfa.webp)
...
2. **開啟 GitHub Copilot Chat 面板：**  
   ...
   ![步驟 2：開啟 Copilot Chat 面板](../../../../../../translated_images/zh-MO/step2-copilot-panel.f1cc86e9b9b8cd1a.webp)

3. **啟用代理模式並確認工具：**  
   在 Copilot Chat 面板中啟用代理模式。

   ![步驟 3：啟用代理模式並確認工具](../../../../../../translated_images/zh-MO/step3-agent-mode.cdc32520fd7dd1d1.webp)

   啟用後，確認 MCP 伺服器已列為可用工具之一。這確保 Copilot 代理能存取文件伺服器，取得相關資訊。

   ![步驟 3：確認 MCP 伺服器工具](../../../../../../translated_images/zh-MO/step3-verify-mcp-tool.76096a6329cbfecd.webp)
...
4. **開始新對話並提示代理：**  
   ...
   ![步驟 4：在聊天中提示代理](../../../../../../translated_images/zh-MO/step4-prompt-chat.12187bb001605efc.webp)
...
5. **即時查詢：**
   ...
   *「我想了解如何部署多代理解決方案，這些 AI 代理是在 Azure AI Foundry 上開發的。我發現沒有直接的部署方式，例如 Copilot Studio 頻道。那麼，企業用戶要如何部署，才能互動並完成工作？  
   ...
   ![步驟 5：即時查詢](../../../../../../translated_images/zh-MO/step5-live-queries.49db3e4a50bea273.webp)
